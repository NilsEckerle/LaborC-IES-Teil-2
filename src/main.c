...
t_state_machine *configure_state_machine() {
	...
	STATE_add_edge(t_state_config, condition_USART_lfconfigstatic, t_state_config_lf_static);
	...
	STATE_add_edge(t_state_config_rounds, condition_USART_isdigit, t_state_config_rounds);
