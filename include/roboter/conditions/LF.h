...
/**
 * @brief Checks if robot should transition from left to forward
 * @param inst State instance (unused)
 * @param vp_dto Data transfer object (unused)
...
/**
 * @brief Checks if robot should transition from right to forward
 * @param inst State instance (unused)
 * @param vp_dto Data transfer object (unused)
 * @return 1 if condition is met, 0 otherwise
 */
...
/**
 * @brief Checks if robot should transition into left turn
 * @param inst State instance (unused)
 * @param vp_dto Data transfer object (unused)
 * @return 1 if condition is met, 0 otherwise
 */
uint8_t condition_LF_L_X_X(t_state *inst __attribute__((unused)),
                           void *vp_dto __attribute__((unused)));

/**
 * @brief Checks if robot should transition into right turn
 * @param inst State instance (unused)
 * @param vp_dto Data transfer object (unused)
 * @return 1 if condition is met, 0 otherwise
 */
uint8_t condition_LF_X_X_R(t_state *inst __attribute__((unused)),
                           void *vp_dto __attribute__((unused)));

/**
 * @brief Checks if robot should transition into forward
 * @param inst State instance (unused)
 * @param vp_dto Data transfer object (unused)
 * @return 1 if condition is met, 0 otherwise
 */
 ...
 * @return 1 if condition is met, 0 otherwise
 */
uint8_t condition_LF_nL_M_X(t_state *inst __attribute__((unused)),
                            void *vp_dto __attribute__((unused)));
 ...
 * @return 1 if condition is met, 0 otherwise
 */
uint8_t condition_LF_X_M_nR(t_state *inst __attribute__((unused)),
                            void *vp_dto __attribute__((unused)));
