...
/**
 * @brief Sets a bolean flag in the roboter_model to print out the time a lap took.
 * @param tp_current_state Current state instance (unused)
 * @param vp_dto Pointer to uint8_t value containing new round count
 * @note Updates ROBOTER_get_instance()->b_round_timing and prints confirmation
 */
