# 0 "main.c"
# 1 "/home/ies/Documents/LaborC-IES-Teil-2/test/dyn_arr//"
# 0 "<built-in>"
# 0 "<command-line>"
...
int main(void) {
 ...
 do { void *vp_data = malloc(sizeof(typeof(1))); typeof(1) tmp = (1); memcpy(vp_data, &tmp, sizeof(typeof(1))); _DYN_ARR_add(&tdynarr_array_int, vp_data); } while (0);
 do { void *vp_data = malloc(sizeof(typeof(2))); typeof(2) tmp = (2); memcpy(vp_data, &tmp, sizeof(typeof(2))); _DYN_ARR_add(&tdynarr_array_int, vp_data); } while (0);
 do { void *vp_data = malloc(sizeof(typeof(3))); typeof(3) tmp = (3); memcpy(vp_data, &tmp, sizeof(typeof(3))); _DYN_ARR_add(&tdynarr_array_int, vp_data); } while (0);
 do { void *vp_data = malloc(sizeof(typeof(4))); typeof(4) tmp = (4); memcpy(vp_data, &tmp, sizeof(typeof(4))); _DYN_ARR_add(&tdynarr_array_int, vp_data); } while (0);
...
# 38 "main.c"
 ...
 printf("%s %d\n%s %d\n%s %d\n%s %d\n",
   ((t_person*)DYN_ARR_get(&tdynarr_array_t_person, 0))->name,
   ((t_person*)DYN_ARR_get(&tdynarr_array_t_person, 0))->age,
   ((t_person*)DYN_ARR_get(&tdynarr_array_t_person, 1))->name,
   ((t_person*)DYN_ARR_get(&tdynarr_array_t_person, 1))->age,
   (*(t_person **)DYN_ARR_get(&tdynarr_array_t_person, 2))->name,
   (*(t_person **)DYN_ARR_get(&tdynarr_array_t_person, 2))->age,
   ((t_person*)DYN_ARR_get(&tdynarr_array_t_person, 3))->name,
   ((t_person*)DYN_ARR_get(&tdynarr_array_t_person, 3))->age
   );
...
# 0 "<command-line>" 2
# 1 "dynamic_array.c"
# 1 "../../include/tools/dynamic_array.h" 1
...
typedef __uintmax_t uintmax_t;
# 10 "/usr/lib/gcc/x86_64-linux-gnu/12/include/stdint.h" 2 3 4
# 5 "../../include/tools/dynamic_array.h" 2
# 1 "/usr/include/string.h" 1 3 4
# 26 "/usr/include/string.h" 3 4
# 1 "/usr/include/x86_64-linux-gnu/bits/libc-header-start.h" 1 3 4
# 27 "/usr/include/string.h" 2 3 4
...
# 6 "../../include/tools/dynamic_array.h" 2





# 10 "../../include/tools/dynamic_array.h"
typedef struct dynamic_array {
 void **vpp_data_array;
 uint8_t ui8_size;
...
void *DYN_ARR_get(t_dyn_arr *tdynarrp_array, int8_t ui8_index);
int8_t DYN_ARR_deconstructor(t_dyn_arr *tdynarrp_array);
# 34 "../../include/tools/dynamic_array.h"
static inline t_dyn_arr DYN_ARRAY_constructor() {
 return (t_dyn_arr) {
  .vpp_data_array = 
# 36 "../../include/tools/dynamic_array.h" 3 4
                   ((void *)0)
# 36 "../../include/tools/dynamic_array.h"
                       ,
  .ui8_size = 0,
    .fp_add = _DYN_ARR_add,
  .fp_get = DYN_ARR_get,
...
# 1 "../../include/tools/logger.h" 1



# 1 "../../include/tools/iesusart.h" 1
# 26 "../../include/tools/iesusart.h"
...
# 9 "dynamic_array.c"
 ...
 if (tdynarrp_array->vpp_data_array == 
# 20 "dynamic_array.c" 3 4
                                      ((void *)0)
# 20 "dynamic_array.c"
                                          ) {
  printf("[FATAL] " "[_DYN_ARR_add] malloc failed!\n");
 ...
 printf("[INFO] " "[_DYN_ARR_add] added element '%p' to dyn_arr.\n", vp_data);
...
int8_t DYN_ARR_deconstructor(t_dyn_arr *tdynarrp_array) {
 if (
# 49 "dynamic_array.c" 3 4
    ((void *)0) 
# 49 "dynamic_array.c"
         != tdynarrp_array) {
  if (
# 50 "dynamic_array.c" 3 4
     ((void *)0) 
# 50 "dynamic_array.c"
          != tdynarrp_array->vpp_data_array) {
   if (tdynarrp_array->ui8_size > 0) {
    for (int i = 0; i < tdynarrp_array->ui8_size; i++) {
     if (
# 53 "dynamic_array.c" 3 4
        ((void *)0) 
# 53 "dynamic_array.c"
             != tdynarrp_array->vpp_data_array[i]) {
      free(tdynarrp_array->vpp_data_array[i]);
     }
    }
   }
   free(tdynarrp_array->vpp_data_array);
  }
  free(tdynarrp_array);
 }
